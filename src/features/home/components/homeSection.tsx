  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-3xl sm:text-5xl font-serif text-gray-800 mb-4">
          Bienvenida a Nuestro Mundo de Amor
        </h1>
        <p className="text-base sm:text-xl text-gray-600 max-w-md sm:max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="relative h-56 sm:h-96 rounded-3xl overflow-hidden shadow-2xl">
        <img
        ...
        <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
          <h3 className="text-lg sm:text-2xl font-serif">Momentos Especiales</h3>
          <p className="text-white/80 text-xs sm:text-base">Cada instante contigo es único</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
        {[
          ...
          <div key={index} className="text-center p-4 sm:p-6 bg-white/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/50">
